...
import { selectanimalsAndNature } from "../features/movies/movieSlice"
import {Carousel, Wrap} from "../MyStyle"

function AnimalsAndNature(props) {
  const movies = useSelector(selectanimalsAndNature);
